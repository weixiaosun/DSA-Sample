...
: parent(the_load_threshold,thash), root_size(the_load_threshold,thash),
  histogram(the_load_threshold,thash){
}
...
T HashEquivalence<T,thash>::compress_to_root (T a) {
      ...
      for (const T& x : compress_set) {
        ...
        average_size += compress_set.size();
...
std::string HashEquivalence<T,thash>::equivalence_info () const {
    long avg = average_size/total_calls;
  std::ostringstream answer;
  answer << "  maximum_size of compress_set   : " << max_compress_size << std::endl;
  answer << "  histogram of compress_size     : " << histogram         << std::endl;
  answer << "  total calls to compress_to_root: " << total_calls       << std::endl;
  answer << "  average_size compress_set      : " << avg               << std::endl;
